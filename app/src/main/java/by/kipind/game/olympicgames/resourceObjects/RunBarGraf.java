...
public class RunBarGraf extends BaseResConteiner {
    ...
    public RunBarGraf(BaseGameActivity activity) {
	...
	textureRegionRes.put("bt_run_jump_region", BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(hudTextureAtlas, activity, "btn/atlas_bt_run_jump.png", 3, 1));
